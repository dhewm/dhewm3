...
enum D3ImGuiWindow {
	...
	D3_ImGuiWin_ScriptEditor = 64, // next should be 128, then 256, etc so a bitmask can be used

	D3_ImGuiWin_AnyEditor = D3_ImGuiWin_LightEditor | D3_ImGuiWin_AfEditor | D3_ImGuiWin_PDAEditor | D3_ImGuiWin_ParticleEditor | D3_ImGuiWin_ScriptEditor // to decide whether to call DrawToolWindows()
};
