...
extern idCVar	g_useRandomEncounters;		// sikk - Random Encounters

extern idCVar	g_useRealisticAmmoUsage;	// sikk - Realistic Reloading Ammo Usage

extern idCVar	g_useExplosionFX;			// sikk - Explosion Radial Blur

// sikk---> Weapon Awareness
extern idCVar	g_useWeaponAwareness;
extern idCVar	g_weaponAwarenessDistance;
// <---sikk
...
extern idCVar	g_useHealthRegeneration;
...
extern idCVar	g_useRandomEnemyHealth;
extern idCVar	g_randomEnemyHealthScale;
// <---sikk

// sikk---> Zombie Resurrection
extern idCVar	g_useZombieResurrection;
extern idCVar	g_zombieResurrectionCount;
// <---sikk
