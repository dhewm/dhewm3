...
// sikk---> Random Encounters
idCVar g_useRandomEncounters(		"g_useRandomEncounters",		"0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"enables random zombies to spawn around a map. *Highly experimental*" );
// <---sikk

// sikk---> Realistic Reloading Ammo Usage
idCVar g_useRealisticAmmoUsage(		"g_useRealisticAmmoUsage",		"0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"enables realistic ammo usage when reloading and collecting ammo" );
// <---sikk

// sikk---> Explosion Radial Blur
...
// sikk---> Weapon Awareness
idCVar g_useWeaponAwareness(		"g_useWeaponAwareness",			"0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"enables weapon awareness" );
idCVar g_weaponAwarenessDistance(	"g_weaponAwarenessDistance",	"32",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER,	"max distance for weapon awareness" );
// <---sikk

// sikk---> Random Enemy Health
idCVar g_useRandomEnemyHealth(		"g_useRandomEnemyHealth",		"0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"enable random enemy health" );
idCVar g_randomEnemyHealthScale(	"g_randomEnemyHealthScale",		"1.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"sets the health scale when g_useRandomEnemyHealth = 1\nFormula: randomHealth = defaultHealth + random( defaultHealth * g_randomEnemyHealthScale )" );
// <---sikk

// sikk---> Zombie Resurrection
idCVar g_useZombieResurrection(		"g_useZombieResurrection",		"0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"enable resurrecting zombies" );
idCVar g_zombieResurrectionCount(	"g_zombieResurrectionCount",	"1",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER,	"sets the total number of times a zombie can resurrect. The chance for a zombie to resurrect is still randomized" );
// <---sikk
...
idCVar g_ambientLightColor(			"g_ambientLightColor",			"0.125 0.125 0.125",	CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE,	"sets the ambient light's color (RGB = 0.0 to 1.0)" );
// <---sikk

// sikk---> Blood Spray Screen Effect
idCVar g_showBloodSpray(			"g_showBloodSpray",				"1",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"show blood spray effect on screen when inflicting damage up close" );
idCVar g_bloodSprayTime(			"g_bloodSprayTime",				"5",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER, "how long blood spray effect lasts (in seconds)" );
...
idCVar g_useHealthRegeneration(		"g_useHealthRegeneration",		"0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"use regenerative health system" );
...
idCVar r_hdrLumThresholdMax(		"r_hdrLumThresholdMax",			"1.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Minimum luminance value threshold" );
idCVar r_hdrLumThresholdMin(		"r_hdrLumThresholdMin",			"0.15",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Maximum luminance value threshold" );
...
idCVar r_hdrBloomMiddleGray(		"r_hdrBloomMiddleGray",			"0.09",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Middle gray value used in HDR tone mapping, specific to bloom" );
...
idCVar r_hdrBloomThreshold(			"r_hdrBloomThreshold",			"3.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Bloom luminance threshold" );
idCVar r_hdrBloomOffset(			"r_hdrBloomOffset",				"6.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Bloom luminance offset" );
...
idCVar r_dofNear(					"r_dofNear",					"-64",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER,	"Set the near distance for depth of field postprocessing effect (r_useDepthOfField = 2 only)" );
idCVar r_dofFar(					"r_dofFar",						"512",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER,	"Set the far distance for depth of field postprocessing effect (r_useDepthOfField = 2 only)" );
idCVar r_dofFocus(					"r_dofFocus",					"64",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER,	"Set the focus distance for depth of field postprocessing effect (r_useDepthOfField = 2 only)" );
...
idCVar r_useMotionBlur(				"r_useMotionBlur",				"0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"Enable motion blur postprocessing effect" );
