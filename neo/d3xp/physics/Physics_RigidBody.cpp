...
//     depends on gameLocal.gameFps which can change at runtime
...
bool idPhysics_RigidBody::CollisionImpulse( const trace_t &collision, idVec3 &impulse ) {
	...
	const float STOP_SPEED = (10.0f * 60.0f) / gameLocal.gameFps; // DG: moved this here because gameLocal.gameFps can change
