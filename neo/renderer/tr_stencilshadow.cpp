...
===============
*/
static inline bool PointsOrdered( const idVec3 &a, const idVec3 &b ) {
    float   i, j;
...
===================
*/
static inline void R_ProjectPointsToFarPlane( stencilRef_t *st, const idRenderEntityLocal *ent, const idRenderLightLocal *light,
...
=============
*/
static inline int R_ChopWinding( clipTri_t clipTris[2], int inNum, const idPlane &plane ) {
    clipTri_t   *in, *out;
...
===================
*/
static inline bool  R_ClipTriangleToLight( stencilRef_t *st, const idVec3 &a, const idVec3 &b, const idVec3 &c, int planeBits,
...
===================
*/
static inline bool R_ClipLineToLight( const idVec3 &a, const idVec3 &b, const idPlane frustum[6], idVec3 &p1, idVec3 &p2 ) {
    float   *clip;
    int     j;
    float   d1, d2;
    float   f;
...
==================
*/
static inline void R_AddClipSilEdges( stencilRef_t *st ) {
    int     v1, v2;
    int     v1_back, v2_back;
    int     i;
...
=================
*/
static inline void R_AddSilEdges( stencilRef_t *st, const srfTriangles_t *tri, unsigned short *pointCull, const idPlane frustum[6] ) {
    int     v1, v2;
    int     i;
    silEdge_t   *sil;
    int     numPlanes;
...
================
*/
static inline void R_CalcPointCull( stencilRef_t *st, const srfTriangles_t *tri, const idPlane frustum[6], unsigned short *pointCull ) {
    int i;
    int frontBits;
    ...
    // duzenko: we have a generic SSE and AVX* versions of this routine, neither of them using temp buffers
...
=================
*/
static inline void R_CreateShadowVolumeInFrustum( stencilRef_t *st,
...
srfTriangles_t *R_CreateShadowVolume( const idRenderEntityLocal *ent,
    ...
    if ( 1 /* sortCapIndexes */ ) {
        ...
        SIMDProcessor->Memcpy( newTri->indexes, st->shadowIndexes,
            newTri->numIndexes * sizeof( newTri->indexes[0] ) );
    }
